...
write.csv(dds_res_sig, file="significant_intergenic_NMF.based.count.APOBEC.b.mutations.csv")
write.csv(dds_res, file="all_significant_intergenic_NMF.based.count.APOBEC.b.mutations.csv")
