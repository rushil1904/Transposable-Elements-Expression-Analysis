...
#saveRDS(dataset_ordered, file="Dataset_RE_intergenic_TEEAnalysis.rds")
...
write.csv(dds_res_sig, file="significant_intergenic.csv")
write.csv(dds_res, file="all_significant_intergenic.csv")
