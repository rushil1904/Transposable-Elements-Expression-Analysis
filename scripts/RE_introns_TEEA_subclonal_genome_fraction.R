...
write.csv(dds_res_sig, file="significant_introns_subclonal_genome_fraction.csv")
write.csv(dds_res, file="all_significant_introns_subclonal_genome_fraction.csv")
