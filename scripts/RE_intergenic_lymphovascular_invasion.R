...
write.csv(dds_res_sig, file="significant_intergenic_lymphovascular_invasion.csv")
write.csv(dds_res, file="all_significant_intergenic_lymphovascular_invasion.csv")
