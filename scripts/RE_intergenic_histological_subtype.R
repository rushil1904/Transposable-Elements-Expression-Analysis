...
annotation_c <- dplyr::select(Histologic_subtype_clinical_df, paper_Histologic.subtype)
View(annotation_c)
...
write.csv(dds_res_sig, file="significant_intergenic_histologic_subtype.csv")
write.csv(dds_res, file="all_significant_intergenic_histologic_subtype.csv")
