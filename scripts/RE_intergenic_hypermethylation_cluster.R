...
annotation_c <- dplyr::select(hypermethylation_cluster_clinical_df, paper_Hypermethylation.cluster)
...
write.csv(dds_res_sig, file="significant_intergenic_hypermethylation_cluster.csv")
write.csv(dds_res, file="all_significant_intergenic_hypermethylation_cluster.csv")
