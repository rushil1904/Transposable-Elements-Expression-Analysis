...
annotation_c <- dplyr::select(hypomethylation_cluster_clinical_df, paper_Hypomethylation.cluster)
...
write.csv(dds_res_sig, file="significant_intergenic_hypomethylation_cluster.csv")
write.csv(dds_res, file="all_significant_intergenic_hypomethylation_cluster.csv")
