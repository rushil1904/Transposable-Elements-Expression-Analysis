...
write.csv(dds_res_sig, file="significant_introns_hypermethylation_cluster.csv")
write.csv(dds_res, file="all_significant_introns_hypermethylation_cluster.csv")
