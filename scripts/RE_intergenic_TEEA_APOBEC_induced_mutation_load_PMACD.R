...
write.csv(dds_res_sig, file="significant_intergenic_APOBEC.induced.mutation.load..PMACD.csv")
write.csv(dds_res, file="all_significant_intergenic_APOBEC.induced.mutation.load..PMACD.csv")
