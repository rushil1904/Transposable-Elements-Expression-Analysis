...
which( colnames(clinical)=="paper_NMF.based.count.APOBEC.a.mutations")
...
write.csv(dds_res_sig, file="significant_raw_paper_NMF.based.count.APOBEC.a.mutations.csv")
write.csv(dds_res, file="all_significant_raw_paper_NMF.based.count.APOBEC.a.mutations.csv")
