...
which( colnames(clinical)=="paper_Subclonal.genome.fraction.from.ABSOLUTE")
...
write.csv(dds_res_sig, file="significant_raw_subclonal_genome_fraction.csv")
write.csv(dds_res, file="all_significant_raw_subclonal_genome_fraction.csv")
