...
which( colnames(clinical)=="paper_Neoantigen.load")
...
write.csv(dds_res_sig, file="significant_raw_neoantigen_load.csv")
write.csv(dds_res, file="all_significant_raw_neoantigen_load.csv")
