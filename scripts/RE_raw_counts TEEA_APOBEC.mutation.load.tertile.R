...
which( colnames(clinical)=="paper_APOBEC.mutation.load.tertile")
...
write.csv(dds_res_sig, file="significant_raw_paper_APOBEC.mutation.load.tertile.csv")
write.csv(dds_res, file="all_significant_raw_paper_APOBEC.mutation.load.tertile.csv")
